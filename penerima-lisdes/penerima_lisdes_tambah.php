...
$query = "INSERT INTO tb_penerima_lisdes (nama_calon_konsumen, nik, alamat, id_kab_kota, id_kecamatan, id_desa, membutuhkan_bantuan, menunggu_bantuan, menaati_ketentuan, jarak_rumah, petugas_survei, status_pemasangan, catatan) VALUES ('$nama_calon_konsumen', '$nik', '$alamat', '$id_kab_kota', '$id_kecamatan', '$id_desa', '$membutuhkan_bantuan', '$menunggu_bantuan', '$menaati_ketentuan', '$jarak_rumah', '$petugas_survei', '$status_pemasangan', '$catatan')";
