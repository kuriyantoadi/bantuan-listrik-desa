...
$id_staff_desa = mysqli_real_escape_string($koneksi, $_POST['id_staff_desa']);
...
$cek_username = mysqli_query($koneksi, "SELECT username FROM tb_staff_desa WHERE username='$username' AND id_staff_desa != '$id_staff_desa'");
...
$cek_edit = mysqli_query($koneksi, "UPDATE tb_staff_desa SET
        username='$username',
        ...
        WHERE id_staff_desa='$id_staff_desa'");
